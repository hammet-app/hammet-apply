    ...
    >
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" aria-hidden="true">
            <rect x="4" y="9" width="17" height="17" rx="4" fill="#5B21B6" opacity="0.5" />
            <rect x="9" y="4" width="17" height="17" rx="4" fill="white" opacity="0.9" />
          </svg>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "56px 24px 80px", position: "relative" }}>
        ...
        <div style={{ marginBottom: 48, textAlign: "center" }}>
          <div style={{
            ...
            <span style={{ color: "#06B6D4", fontSize: 12, fontWeight: 600, letterSpacing: "0.08em" }}>
              NYSC BATCH A STREAM II · NOW OPEN
            </span>
          </div>
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 16, lineHeight: 1.7, maxWidth: 500, margin: "0 auto" }}>
            Paid, in-person roles for NYSC Batch A Stream II Corps Members serving in Ibadan.
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
          <RoleCard emoji="🎬" title="Video Editor" spots={2} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              ...
              "Your location — you must be open to serving in Ibadan",
